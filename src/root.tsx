...
ReactDOM.createRoot(root!).render(
    <BrowserRouter>
        <Routes>
            <Route path="/mobile" element={<FrontPage api={"/api/tracker/routes"} displayNavigation={false} displayOperator={true}/>} />
            ...
            <Route path="/" element={<FrontPage api={"/api/tracker/routes"} displayNavigation={false} displayOperator={false}/>} />
